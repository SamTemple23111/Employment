...
<body>
    ...
    <div class="text-center">
        <h1 class="display-4 fw-bold">قائمة المنشآت: </h1>
    </div>
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_array($query)) {
                    ...
                    <td>' . $row['country'] . ' ' . $row['city'] . '</td>
                                                            ...
                                                            <td><a href="dashboard/admin/remove_facility_details.php?$id=' . $row['id'] . '""><button type="button" class="btn btn-outline-secondary btn-sm">المزيد</button></a></td>
                </tr>';
                }
                ?>
