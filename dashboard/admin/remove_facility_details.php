...
if (isset($_POST['delete'])) {
    ...
    $sql_delete_apply = "DELETE from users_apply where facility_id = $id";
    $query_delete_apply = mysqli_query($conn, $sql_delete_apply);

    $sql_delete_apply = "DELETE from facilities_request where id_fk = $id";
    $query_delete_apply = mysqli_query($conn, $sql_delete_apply);

    $sql_delete = "DELETE from facilities where id = $id";
    $query_delete = mysqli_query($conn, $sql_delete);

    echo "<script>alert('تم حذف حساب المنشأة والإعلانات والطلبات المقدمه')</script>";
                    ...
                    <div class="card mb-4">
                        <div class="card-body text-center">
                            ...
                            <div class="d-flex justify-content-center mb-2">
                                                            <form method="POST" action="remove_facility_details?$id=' . $id . '">
