            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_array($query)) {
                    ...
                    <td>' . $row['ads_created_time'] . '</td>
                                                            ...
                                                            <td><a href="dashboard/admin/remove_ads_done.php?$id_request=' . $row['id_request'] . '""><button type="button" class="btn btn-outline-danger btn-sm">حذف الإعلان</button></a></td>
                </tr>';
                }
                ?>
